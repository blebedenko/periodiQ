...
#' return parameters of selected scneario
#'
#' @param scenario_name a string "C1" , "C2", "C3", "C4" - defaults to "C4"
#'
#' @return param_list corresponding to the provided scenario
#' @export
#'
scenario_params <-
function(scenario_name = "C4", sample_size = 1000) {
  ## LIST OF PARAMETER VALUES FOR QUICK ACCESS -----
  list_of_param_lists <- list(
    C1 = param_list(
      gamma = 10,
      lambda_0 = 10,
      theta = 2,
    ...
    return(list_of_param_lists[[scenario_name]])
...
#'
#'
#'     customer <- customer_gamma(params = params)  # generate patience and job size:
#'     B <- customer$jobsize
#'     Y <- customer$patience
